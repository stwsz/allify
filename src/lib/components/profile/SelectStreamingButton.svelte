...
<button
	type="button"
	on:click={onClick}
	class={`flex w-full cursor-pointer items-center justify-center gap-2 text-xs rounded-xl px-6 py-2.5 font-medium capitalize transition-all duration-200 lg:text-sm
		${
			selected
				? streaming === 'spotify'
