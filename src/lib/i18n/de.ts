export const de = {
	...
	configuration: {
		langAttribute: 'de_DE',
		metaOgAndTwitterContent: 'Verstehe deine Musikgewohnheiten mit echten Daten.',
		metaDescriptionContent:
			'Verbinde deine Streaming-Plattformen, analysiere deine Musikgewohnheiten und entdecke neue Tracks mit Allify.'
	},
	generalTexts: {
		logoColorfulAltText: 'Farbiges Allify-Logo',
		logoLightAltText: 'Helles Allify-Logo',
		alliFullBodyAltText:
			'Illustration des Allify-Maskottchens namens Alli mit vollem Körper, lächelnd und winkend',
	...
	homePage: {
		...
		connectPlatformCardPlatformConnectButton: 'Verbinden',
		connectPlatformCardPlatformConnectButtonAriaLabel: 'Mit der Plattform verbinden',
		connectPlatformCardPlatformConnectedButton: 'Verbunden',
		connectPlatformCardPlatformConnectedButtonAriaLabel: 'Plattform verbunden',
