export const es = {
	...
	configuration: {
		...
		metaDescriptionContent:
			'Conecta tus plataformas de streaming, analiza tus hábitos musicales y descubre nuevas canciones con Allify.'
	},
	generalTexts: {
		logoColorfulAltText: 'Logotipo colorido de Allify',
		logoLightAltText: 'Logotipo claro de Allify',
		alliFullBodyAltText:
			'Ilustración de la mascota de Allify, llamada Alli, con cuerpo completo, sonriendo y saludando',
	...
	myMusicalProfilePage: {
		...
		myMusicalProfilePageMostListenedArtistsHeading1: 'Tus artistas favoritos',
	...
	profilePage: {
		title: 'Perfil | Allify',
		profilePageImageAltText: 'Foto del perfil de',
		profilePageFollowers: 'seguidores',
		profilePageHeading1: '¡Hola, {{name}}! Aquí está todo lo que necesitas saber sobre tu perfil.'
	},
	errorPage: {
